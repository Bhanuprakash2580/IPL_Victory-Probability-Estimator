...
* Match snapshot insights
* Dynamic win percentage bars
* Simple and interactive input controls
...
* Batting Team Win Probability: 70%
* Bowling Team Win Probability: 30%
...
* Feature engineering from live match data
